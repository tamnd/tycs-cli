...
// HTTP behaviour is covered in tycs_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "tycs://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("tycs", "about")
	if err != nil || got.String() != "tycs://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want tycs://page/about", got.String(), err)
	}
}
