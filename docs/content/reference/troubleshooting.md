...
Most of these come down to network reality or how tycs serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

tycs rate-limits like any public site. tycs already paces
...
Where a surface is gated, tycs reads a cookie or token you supply
...
`tycs`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what tycs actually did
